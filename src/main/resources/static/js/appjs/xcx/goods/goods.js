						...
						columns : [
								{
									...
									title : 'uuid' 
																...
																{
									field : 'cname', width :300,
									title : '商品标题'
								},
																{
									field : 'ename', visible : false,
									title : '英文名字' 
								},
																{
									...
									title : '编号' 
																...
																{
									field : 'quality',width :80,
									title : '材质' 
								},
																{
									field : 'material', visible : false,
									title : '材料' 
								},
																{
									field : 'describe', visible : false,
									title : '详细描述',
                                     width :40
								},
																{
									...
									title : '特点' 
																...
																{
									field : 'market', visible : false,
									title : '上市时间' 
								},
																{
									field : 'colour', visible : false,
									title : '颜色' 
								},
																{
									field : 'others', visible : false,
									title : '其他' 
								},{
                                ...
                                title : '品牌'
									...
									title : '创建时间' 
																...
																{
									field : 'gtmModified',visible : true,
									title : '修改时间' 
								},
                            {
